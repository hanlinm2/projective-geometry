...
from lines_dataset import get_test_dataloaders
...
if __name__ == "__main__":
    ...
    easy_dataloader, unconfident_dataloader, misclassified_dataloader = get_test_dataloaders(test_image_paths, unconfident_image_paths, misclassified_image_paths, image_path_to_lines, class_to_idx)
