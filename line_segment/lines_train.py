...
from lines_path_helpers import load_all_paths, remove_problem_paths, load_image_path_to_lines
from lines_dataset import get_train_dataloaders
from lines_model import create_model
...
def train(model, train_dataloader, val_dataloader, save_path_prefix):
    ...
    print(f"Training Line Segment Classifier: {category.capitalize()} Setting.\n")
...
if __name__ == "__main__":
    ...
    save_path_prefix = f"./checkpoints/Lines_{category}"
    
    train_dataloader, val_dataloader = get_train_dataloaders(train_image_paths, val_image_paths, image_path_to_lines, class_to_idx)
